...
<section>
<h2>Seba99317 - WEB Board Uploader</h2>
<hr />
<span>Wybierz <u>WSZYSTKIE</u> pliki z <i>/data/www/</i><br />i prześlij je za pomocą poniższego formularza</span>
<hr />
<form action="/%ACTION%" method="post" enctype="multipart/form-data">
<p><label for="www">www:</label> <input type="file" name="www" id="www" multiple></p>
<hr />
<span>-= OPCJONALNE =-<br />Możesz również przesłać pliki <i>playlist.csv</i><br />oraz <i>wifi.csv</i> ze swojej kopii zapasowej</span>
...
<hr />
<form action="/%ACTION%" method="post" enctype="multipart/form-data">
<span>-= OPCJONALNE =-<br />Jeśli nie możesz połączyć się z adresem 192.168.4.1 z komputera,<br />najpierw skonfiguruj połączenie Wi-Fi</span>
...
<p><input type="submit" name="submit" value="Zapisz dane logowania"></p>
</form>
</div>
</section>
</body></html>
